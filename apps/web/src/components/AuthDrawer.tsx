...
export function AuthDrawer({
  ...
  function redirectByRole(token: string, user: AuthUser) {
    ...
    if (user.role === "admin" || user.role === "staff") {
      ...
      router.replace(
        nextParam === "/admin" ? "/account" : (nextParam ?? "/account"),
      );
    }
    onClose();
  }
  ...
  const inputClass =
    "w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-gray-900 focus:bg-white focus:ring-4 focus:ring-gray-100";
  const labelClass =
              ...
              <div
                ...
                <div
                  ...
                  <Button
                    type="button"
                    variant="secondary"
                    className="w-full rounded-xl text-gray-700"
            ...
            <div
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#bbb" }}>
                ...
                <Button
                  ...
                  className="h-auto rounded-md px-1 py-0 text-xs text-neutral-950">
